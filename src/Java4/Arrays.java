...
public class Arrays {
    public static void main(String[] args) {
        ...
        int intArray[] = new int[4];//intArray is a variable name, int[]-> int array datatype
        ...
        //Example 3: 2-D Array (generally used to in matrix(2*2) multiplication)
        ...
        //Example 4: 3-D Array (generally img data is stored in 3-D)
